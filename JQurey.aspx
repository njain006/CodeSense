<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="JQurey.aspx.cs" Inherits="JQurey" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height: 100%; background-color: #FFFFFF; width: 1450px; margin-left: 243px; margin-right: 0px;" 
        align="center">
   <div style="height: 199px; width: 1123px; background-image: url('images/JQuery.jpg'); margin-left: 130px;" 
        align="left"><br />
       <br />
       <br />
       <br />
       ...
       <div style="border-top: medium inset #C0C0C0; border-left: medium outset #C0C0C0; border-right: medium inset #C0C0C0; height: 63px; width: 556px; background-color: #FFFFFF; margin-left: 208px; margin-bottom: 0px;" 
           ...
           <asp:Label ID="Label1" runat="server" Font-Bold="True" 
               Font-Names="Times New Roman" Font-Size="XX-Large" Text="jQuery"></asp:Label>
       </div></div><br /><br />
       <div align="center" 
