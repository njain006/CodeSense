<%@ Page Title="" Language="C#" MasterPageFile="~/AboutAuthor.master" AutoEventWireup="true" CodeFile="EditAccount.aspx.cs" Inherits="EditAccount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="height: 84px; width: 611px; border-bottom-style: outset; border-top-width: 2px; border-top-color: #C0C0C0;">
        ...
        <asp:Label ID="lblShow" runat="server" Font-Bold="True" 
            ...
            Text="Modify    User    Account"></asp:Label>
        &nbsp;</div>
    <br /><br />
    <div align="left" 
            style="border-bottom-style: outset; border-top-width: 2px; border-top-color: #C0C0C0; height: 212px; width: 611px;">
        &nbsp;<br />
&nbsp;<asp:Label ID="Label2" runat="server" Font-Names="Times New Roman" 
            Font-Size="Medium" ForeColor="Red" Text="* Not allow to Modify : "></asp:Label>
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="lblEmailID" runat="server" Font-Bold="True" 
            Font-Names="Times New Roman" ForeColor="Black" Text="Email_ID"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="lblFirstName" runat="server" Font-Bold="True" 
            Font-Names="Times New Roman" Text="FirstName"></asp:Label>
&nbsp;&nbsp;&nbsp;
        <br />
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="lblLastName" runat="server" Font-Bold="True" 
            Font-Names="Times New Roman" Text="LastName"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="lblStatus" runat="server" Font-Bold="True" 
            Font-Names="Times New Roman" Text="Status"></asp:Label>
        <br />
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;
...
<div align="left" 
            ...
            style="border-bottom: 2px outset #C0C0C0; height: 296px; width: 606px; border-left-color: #C0C0C0; border-left-width: 2px; border-right-color: #C0C0C0; border-right-width: 2px; border-top-color: #C0C0C0; border-top-width: 2px;">
    <br />
&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="lblPassword" runat="server" Font-Bold="True" 
        Font-Names="Times New Roman" Text="Password"></asp:Label>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="lblRepeatPassword" runat="server" Font-Bold="True" 
        Font-Names="Times New Roman" Text="Repeat Password"></asp:Label>
    <br />
    <br />
    &nbsp;&nbsp;
    ...
    <asp:CompareValidator ID="cvRepeatPassword" runat="server" 
        ...
        ErrorMessage="* The two Passwords should be consistent" ForeColor="Red" 
        ValueToCompare="txtPassword.text">*</asp:CompareValidator>
    <asp:RequiredFieldValidator ID="rfvRepeat" runat="server" 
        ControlToValidate="txtRepeatPassword" Display="Dynamic" 
        ErrorMessage="* Repeat password" ForeColor="Red">*</asp:RequiredFieldValidator>
    <br />
    <br />
    <br />
    <br />
&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="lblCountry" runat="server" Font-Bold="True" 
        Font-Names="Times New Roman" Text="Country"></asp:Label>
    <br />
    <br />
...
&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:Button ID="btnSubmit" runat="server" 
        ...
        Font-Names="Times New Roman" Font-Size="Medium" ForeColor="White" Height="27px" 
        Text="Submit" Width="150px" CausesValidation="False" 
        onclick="btnSubmit_Click" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnClear" runat="server" BackColor="Black" Font-Bold="True" 
        Font-Names="Times New Roman" Font-Size="Medium" ForeColor="White" Text="Clear" 
        Width="150px" Height="29px" CausesValidation="False" 
        onclick="btnClear_Click" />
        </div>
    <br /><br />
    <div style="height: 150px; width: 611px">
        <asp:ValidationSummary ID="vsModifyAccount" runat="server" DisplayMode="List" 
            ForeColor="Red" HeaderText="Please correct the following errors :" 
            Height="142px" ShowMessageBox="True" />
        </div>
    </div>
